  ...
  <div class="zhishu">
    ...
    <div class="gva-table-box">
      ...
      >
        ...
        <el-table-column align="left" label="chg_60" prop="chg_60" width="100" sortable="custom"/>
        <el-table-column align="left" label="chg_30" prop="chg_30" width="60" />
...
import { getPctSum } from "@/api/stockRank";
...
const getTableData = async() => {
  const table = await getPctSum({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
